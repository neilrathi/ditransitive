            ...
            <fieldset disabled={connecting}>
              <div>
                ...
                <div className="mt-1">
                  ...
                  />
                  <p
                    className="mt-2 mb-2 text-sm text-gray-500 text-center"
                    id="playerID-description"
                  >
                    Please copy and paste your ID from Prolific. This is very important, we <strong>cannot pay you without it</strong>.
                  </p>
                </div>
              </div>
