...
export function ExChoice() {
  ...
  const instructions = player.get("role") == 'director' ? 'Continue to see an example description.' : 'Click on the image described in the sentence.'
  ...
  return (
    ...
    <table>
      <tr>
        <td style = {{paddingRight: "10px"}}> {instructions} </td>
        <td> {cont} </td>
      </tr>
    </table>
